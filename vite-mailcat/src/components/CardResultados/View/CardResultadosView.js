  ...
  render() {
    const template = `
      <div id="cardResultRoot" class="glass-panel border border-primary/10 rounded-[2rem] overflow-hidden flex flex-col shadow-sm">
        ...
        <div id="result-area" class="p-4 lg:p-6 font-body text-on-surface leading-relaxed relative min-h-[180px] flex flex-col">
          <textarea id="text-result" class="w-full h-full min-h-[180px] custom-scrollbar bg-transparent outline-none resize-none flex-grow"  disabled></textarea>
          <div id="status-overlay" class="absolute inset-0 glass-panel z-10 flex flex-col justify-center items-center pointer-events-none">
            <div id="loading-indicator" class="w-full px-4 lg:px-6 space-y-3 opacity-10">
            ...
            <div id="idle-message" class="absolute inset-0 flex flex-col items-center justify-center text-center p-4 pointer-events-none">
        ...
        <div id="footer-area" class="p-3 bg-surface-container-low flex items-center justify-between border-t border-outline-variant/10">
          <div class="flex items-center gap-2">
